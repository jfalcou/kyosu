...
<typename T>(tts::type<T>)
{
  ...
  std::array<c_t, NTST> w = {
    ...
    tcx(-inf,
        -inf), // 13
    tcx(0.007389128308257135427153919483147229573895, 0.6149332524601658796226417164791221815139),
    tcx(0.4143671923267934479245651547534414976991e8, -0.8298168216818314211557046346850921446950e10),
    tcx(-inf, -inf),
    tcx(0.1128379167099649964175513742247082845155e-5, 0.2256758334191777400570377193451519478895e-5),
    tcx(0, 0.2256758334194034158904576117253481476197e-5),
    tcx(0, 18.56480241457555259870429191324101719886),
    tcx(0, 0.1474797539628786202447733153131835124599e173),
    tcx(0, inf),
    tcx(1, 0),
    tcx(-1, 0),
    tcx(0, inf),
    ...
    tcx(nan, nan),
    tcx(nan, nan),
    tcx(0.07924380404615782687930591956705225541145, 0.07872776218046681145537914954027729115247),
    tcx(0.07885775828512276968931773651224684454495, -0.0007860046704118224342390725280161272277506),
    tcx(-0.1012806432747198859687963080684978759881, 0.0007834934747022035607566216654982820299469),
    tcx(-0.1020998418798097910247132140051062512527, 0.1010030778892310851309082083238896270340),
    tcx(-0.0007962891763147907785684591823889484764272, 0.1018289385936278171741809237435404896152),
    tcx(0.07886408666470478681566329888615410479530, 0.01010604288780868961492224347707949372245),
...
TTS_CASE_WITH("Check behavior of erf on wide", kyosu::simd_real_types, tts::randoms(-1.0, 1.0), tts::randoms(-1.0, 1.0))
