...
<typename T>(tts::type<T>)
{
  ...
  TTS_ULP_EQUAL( kyosu::log_abs_gamma(z_t(-3.5, 0)), kyosu::log_abs_gamma(T(-3.5)), 2.0);
  TTS_ULP_EQUAL( kyosu::log_abs_gamma(z_t(1, 1))   ,   eve::log(kyosu::abs(z_t(0.49801566811835585, 0.1549498283018106))), 2.0);
};
