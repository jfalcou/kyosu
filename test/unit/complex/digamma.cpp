...
<typename T>(tts::type<T>)
{
  ...
  TTS_RELATIVE_EQUAL( kyosu::real(kyosu::digamma(z_t(-3.5, 0))), e_t(1.3888709263595289015114046193821968137592213477205182739052536985), 1.0e-4);
  TTS_RELATIVE_EQUAL( kyosu::real(kyosu::digamma(z_t(-3.75, 0))), e_t(-1.692388598311330343154465211031748512432179503643307206720214624), 1.0e-4);
  TTS_RELATIVE_EQUAL( kyosu::digamma(z_t(1, 1))    , z_t(9.4650320622476947e-02, 1.076674047468581174e+00), 1.0e-4);
  TTS_RELATIVE_EQUAL( kyosu::digamma(z_t(-1, 1))   , z_t(0.594650320622477, 2.576674047468582), 1.0e-4);
  TTS_RELATIVE_EQUAL( kyosu::digamma(z_t(1, -1))   , z_t(9.4650320622476947e-02, -1.076674047468581174e+00), 1.0e-4);
  TTS_RELATIVE_EQUAL( kyosu::digamma(z_t(-1, -1))  , z_t(0.594650320622477, -2.576674047468582), 1.0e-4);;
};
