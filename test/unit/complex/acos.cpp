...
TTS_CASE_WITH("Check behavior of acos on wide", kyosu::simd_real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
<typename T>(T const& a0, T const& a1)
{
  using e_t = T;
  ...
  TTS_RELATIVE_EQUAL(kyosu::acos[a0 > a1](ke_t{a0, a1}),
                     kyosu::if_else(a0 > a1, kyosu::acos(ke_t{a0, a1}), ke_t{a0, a1}), tts::prec<T>());
  TTS_RELATIVE_EQUAL(kyosu::acos[a0 > a1](a0), kyosu::if_else(a0 > a1, kyosu::acos(a0), a0), tts::prec<T>());
};
