...
<typename T>(tts::type<T>)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::lbeta(i, i), z_t(1.2673795683871619728767940, -2.30372328403975132639009246361848),
                     tts::prec<T>());
  TTS_RELATIVE_EQUAL(kyosu::lbeta(i, T(0.5)), z_t(0.574232387827216663459561, -0.917428922919860707555628220702128),
                     tts::prec<T>());
  ...
  TTS_RELATIVE_EQUAL(kyosu::lbeta(i, 2 * i), z_t(1.122607421965134893435985, -2.796141102021254706058936433559202),
                     tts::prec<T>());
};
