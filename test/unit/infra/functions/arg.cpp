...
TTS_CASE_WITH("Check behavior of arg on reals", kyosu::real_types, tts::randoms(1, 10), tts::randoms(-10, -1))
(auto p, auto n)
{
...
TTS_CASE_WITH("Check behavior of arg on complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
