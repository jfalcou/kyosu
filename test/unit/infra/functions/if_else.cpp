...
<typename T>(T const& a0)
{
  ...
  for (auto e : a0)
  {
    ...
    TTS_EQUAL(kyosu::if_else(eve::is_odd(e), kyosu::complex_t<e_t>(0, -e), kyosu::quaternion_t<e_t>(0, e, -1, 2)),
              kyosu::quaternion_t<e_t>(0, m ? -e : e, m ? 0 : -1, m ? 0 : 2));
    TTS_EQUAL(kyosu::if_else(eve::is_odd(e), kyosu::quaternion_t<e_t>(0, -e, 1, -2), kyosu::complex_t<e_t>(0, e)),
...
<typename T>(T const& a0)
{
  ...
  for (auto e : a0)
  {
    ...
    TTS_EQUAL(kyosu::if_else(m, wq_t(q_t(0, -e, 1, -2)), wq_t(q_t(0, e, -1, 2))),
              wq_t(q_t(0, m ? -e : e, m ? 1 : -1, m ? -2 : 2)));
    TTS_EQUAL(kyosu::if_else(m, wc_t(c_t(0, -e)), wq_t(q_t(0, e, -1, 2))),
              wq_t(q_t(0, m ? -e : e, m ? 0 : -1, m ? 0 : 2)));
    TTS_EQUAL(kyosu::if_else(m, wq_t(q_t(0, -e, 1, -2)), wc_t(c_t(0, e))),
              wq_t(q_t(0, m ? -e : e, m ? 1 : 0, m ? -2 : 0)));
  }
};
