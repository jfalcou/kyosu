...
TTS_CASE_WITH("Check kyosu::lipart over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::lipart(data), eve::zero(eve::as(data)));
};

TTS_CASE_WITH("Check kyosu::lipart over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
