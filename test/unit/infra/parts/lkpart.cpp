...
TTS_CASE_WITH("Check kyosu::lkpart over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::lkpart(data), eve::zero(eve::as(data)));
};

TTS_CASE_WITH("Check kyosu::lkpart over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
