...
TTS_CASE_WITH("Check kyosu::ipart over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
...
TTS_CASE_WITH("Check kyosu::ipart over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
