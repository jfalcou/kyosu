...
TTS_CASE("Check as_cayley_dickson_n<N,Ts...> with mixed SIMD types")
{
  ...
  TTS_TYPE_IS((kyosu::as_cayley_dickson_n_t<2, wide<complex_t<float>>, wide<complex_t<float>>>),
              wide<complex_t<float>>);
  ...
  TTS_TYPE_IS((kyosu::as_cayley_dickson_n_t<2, wide<complex_t<double>>, wide<complex_t<double>>>),
              wide<complex_t<double>>);
  ...
  TTS_TYPE_IS((kyosu::as_cayley_dickson_n_t<4, wide<complex_t<double>>, quaternion_t<double>>),
              wide<quaternion_t<double>>);
};
