...
TTS_CASE_TPL("Check as_real_type_t behavior on real types", kyosu::real_types)<typename T>(tts::type<T>)
{
  TTS_TYPE_IS(kyosu::as_real_type_t<T>, T);
};

TTS_CASE_TPL("Check as_real_type_t behavior on non-real types", kyosu::real_types)<typename T>(tts::type<T>)
{
