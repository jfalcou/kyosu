...
TTS_CASE_WITH("Check kyosu::is_not_fnan over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::is_not_fnan(data), eve::is_not_nan(data));
};

TTS_CASE_WITH("Check kyosu::is_not_fnan over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
...
<typename T>(T r, T i, T j, T k)
{
  ...
  TTS_EQUAL(kyosu::is_not_fnan(type(r, i, j, k)),
            eve::is_not_nan(r) || eve::is_not_nan(i) || eve::is_not_nan(j) || eve::is_not_nan(k));
...
<typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  auto z(kyosu::fnan(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_fnan(type(r, i, j, k, l, li, lj, lk)),
            eve::is_not_nan(r) || eve::is_not_nan(i) || eve::is_not_nan(j) || eve::is_not_nan(k) ||
