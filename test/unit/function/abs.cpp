...
TTS_CASE_WITH("Check kyosu::abs over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_ULP_EQUAL(kyosu::abs(data), eve::abs(data), 0.5);
};

TTS_CASE_WITH("Check kyosu::abs over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
...
{
  TTS_ULP_EQUAL(kyosu::abs(kyosu::octonion_t<T>(r, i, j, k, l, li, lj, lk)),
                eve::hypot[eve::pedantic](r, i, j, k, l, li, lj, lk), 0.5);
  TTS_ULP_EQUAL(kyosu::abs[kyosu::raw](kyosu::octonion_t<T>(r, i, j, k, l, li, lj, lk)),
                eve::hypot(r, i, j, k, l, li, lj, lk), 0.5);
  TTS_ULP_EQUAL(kyosu::abs[kyosu::flat](kyosu::octonion_t<T>(r, i, j, k, l, li, lj, lk)),
                eve::maxabs(r, i, j, k, l, li, lj, lk), 0.5);
};
