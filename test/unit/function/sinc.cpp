...
TTS_CASE_WITH("Check kyosu::sinc over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_ULP_EQUAL(kyosu::sinc(data), eve::sinc(data), 0.5);
};
...
TTS_CASE_WITH("Check kyosu::sinc over quaternion",
...
<typename T>(T r, T i, T j, T k)
{
  ...
  auto boost_sinc = [](auto x, auto y, auto z, auto t) {
    return cv(boost::math::sin(bq_t(x, y, z, t)) / bq_t(x, y, z, t));
  };
