...
TTS_CASE_WITH("Check kyosu::exp2 over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::exp2(data), kyosu::inject(eve::exp2(data)));
  TTS_ULP_EQUAL(kyosu::exp2[kyosu::real_only](data), eve::exp2(data), 0.5);
};
