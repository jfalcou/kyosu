...
struct toto
{
  ...
  struct result  : eve::as_wide_as<Z0,Z1>//decltype(kyosu::pow(kyosu::abs(Z0{}), Z1{}))//eve::as_wide_as<Z0,Z1>
  {
    result(){std::cout << " === 0" << std::endl; };
  };
