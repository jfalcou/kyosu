...
TTS_CASE_WITH("Check kyosu::dist over real", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10)
...
(auto r0, auto r1)
{
  ...
  TTS_IEEE_EQUAL(kyosu::dist[eve::pedantic](kyosu::nan(eve::as<e_t>()), kyosu::inf(eve::as<e_t>())),
                 eve::inf(eve::as<e_t>()));
  TTS_IEEE_EQUAL(kyosu::dist[eve::pedantic](kyosu::inf(eve::as<e_t>()), kyosu::inf(eve::as<e_t>())),
                 eve::inf(eve::as<e_t>()));
  TTS_IEEE_EQUAL(kyosu::dist[eve::numeric](kyosu::nan(eve::as<e_t>()), kyosu::nan(eve::as<e_t>())),
                 eve::zero(eve::as<e_t>()));
};
...
(auto r0, auto i0, auto r1, auto i1)
{
  ...
  TTS_IEEE_EQUAL(kyosu::dist(c_t(kyosu::valmax(eve::as<e_t>())), c_t(kyosu::valmin(eve::as<e_t>()))),
                 eve::inf(eve::as<e_t>()));
};
