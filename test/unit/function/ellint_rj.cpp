...
TTS_CASE_TPL("Check ellint_rj over complex", kyosu::scalar_real_types)
<typename T>(tts::type<T>)
{
  ...
  a_t re = {0.77688623778582, 0.14297579667157, 0.13613945827771,  1.6490011662711,
            0.94148358841220, 1.8260115229009,  -0.61127970812028, 1.8249027393704};
