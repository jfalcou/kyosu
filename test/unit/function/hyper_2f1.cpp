...
//    std::cout << tts::name(r_t()) << std::endl;
    ...
    r_t res[] = {r_t(1.34285714285714, 0), r_t(1.34285714285714), kyosu::nan(eve::as<r_t>()), kyosu::nan(eve::as<r_t>()), r_t(1.41666666666667,0), r_t(1.53571428571429,0),
                 ...
                 r_t(1.0, 0.0), r_t(-1.0, 0.0), r_t(0.99605548882, 0.0)};
    r_t r(nan);
