...
TTS_CASE_TPL("Check hyper 2F0", kyosu::scalar_real_types)
<typename T>(tts::type<T>)
{
  auto pr = tts::prec<T>(4.0e-3, 1.0e-8);
  using r_t = kyosu::cayley_dickson<T, 2>;
  r_t r;
  r_t res[] = {r_t(1.0, 0.0),  kyosu::cinf(eve::as<r_t>()),
               r_t(0.52, 0.0), r_t(169, 0.0),
               r_t(121, 0.0),  r_t(1.04166637647907, 8.34584913683906e-8)};
  int i = 0;
