...
<typename T>(tts::type<T>)
{
  if constexpr (sizeof(T) == 8)
  {
    ...
    r_t res[] = {r_t(1.34285714285714, 0),
                 ...
                 r_t(1.43805509807655, 0),
                 r_t(0.399423339498422, 0),
                 r_t(-0.0945434530050565, -0.0128699542349234),
                 r_t(0.292430451098607, 0),
                 r_t(4.26012617974386, -2.13613053370195),
                 r_t(3.25898889914176, 0),
                 r_t(0.784430166457414, 0),
                 r_t(-332.644427109075, -224.988297978431),
                 r_t(23.6353087752502, 25.8503131412853),
                 r_t(-210.714285714285, -5.1610115106924e-14),
                 r_t(-20190.0135825192, 0),
                 r_t(-1.59751695108824e8, -9.828310525088070619e7),
    ...
    rs = kyosu::hypergeometric(r_t(0.4 - 1.2 * I), kumi::tuple{-20.4, -20.4}, kumi::tuple{-20.4});
    TTS_RELATIVE_EQUAL(rs, res[14], pr);
    ...
    r = kyosu::hypergeometric(rw_t(1.000001 - I), kumi::tuple{-10.4, -10.4}, kumi::tuple{-4.4});
    ...
    r = kyosu::hypergeometric(rw_t(0.25), kumi::tuple{0.0, 2.0}, kumi::tuple{1.5});
