...
TTS_CASE_WITH("Check kyosu::sqr over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_ULP_EQUAL(kyosu::sqr(data), eve::sqr(data), 0.5);
};

TTS_CASE_WITH("Check kyosu::sqr over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
<typename T>(T r, T i)
{
