...
(auto r0, auto i0, auto r1, auto i1)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::powm1(c0, c1), kyosu::dec(kyosu::pow(c0, c1)), prec);
  TTS_RELATIVE_EQUAL(kyosu::powm1(r0, c1), kyosu::dec(kyosu::pow(r0, c1)), prec);
  TTS_RELATIVE_EQUAL(kyosu::powm1(c0, r1), kyosu::dec(kyosu::pow(c0, r1)), prec);
};
...
<typename T>(T r0, T i0, T j0, T k0, T r1, T i1, T j1, T k1)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::powm1(q0, q1),  kyosu::dec(kyosu::pow(q0, q1)),prec);
};
