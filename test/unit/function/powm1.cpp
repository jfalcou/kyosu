...
TTS_CASE_WITH("Check kyosu::powm1 over real", kyosu::real_types, tts::randoms(0, 10), tts::randoms(-10, 10)
...
(auto r0, auto r1)
{
  ...
  auto re = kyosu::powm1[kyosu::real_only](r0, r1);
  auto rr = eve::powm1(r0, r1);
