...
TTS_CASE_WITH("Check kyosu::negmaxabs over real", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10)

)
(auto r0, auto r1)
{
  TTS_EQUAL(kyosu::negmaxabs(r0, r1), eve::negmaxabs(r0, r1));
};

TTS_CASE_WITH("Check kyosu::negmaxabs over complex",
              kyosu::real_types,
              tts::randoms(-10, 10),
              tts::randoms(-10, 10),
              tts::randoms(-10, 10),
