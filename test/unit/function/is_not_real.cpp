...
TTS_CASE_WITH("Check kyosu::is_not_real over not_real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::is_not_real(data), eve::false_((eve::as(data))));
};

TTS_CASE_WITH("Check kyosu::is_not_real over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
