...
TTS_CASE_WITH(
  "Check kyosu::sub over real", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10), tts::randoms(-10, 10)
...
<typename T>(T r0, T i0, T r1, T i1)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::sub[r0 > 0](r0, c1, r1), kyosu::if_else(r0 > 0, (r0 - c1 - r1), kyosu::complex(r0)),
                     tts::prec<T>());
  // TTS_RELATIVE_EQUAL(kyosu::sub[r0 > 0](kumi::tuple(r0, c1, r1)), kyosu::if_else(r0 > 0, (r0+c1+r1),
  // kyosu::complex(r0)), tts::prec<T>());
};
...
<typename T>(T r0, T i0, T j0, T k0, T r1, T i1, T j1, T k1)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::sub[r0 > 0](r0, q1, r0), kyosu::if_else(r0 > 0, (r0 - q1 - r0), kyosu::quaternion(r0)),
                     tts::prec<T>());
};
