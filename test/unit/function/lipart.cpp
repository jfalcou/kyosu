...
(auto r, auto i)
{
  TTS_EQUAL(kyosu::lipart(kyosu::complex(r,i)), eve::zero(eve::as(r)));
};
  ...
  <typename T>(T r, T i, T j, T k)
{
  ...
  TTS_EQUAL(kyosu::lipart(type(r,i,j,k)), eve::zero(eve::as(r)));
};
  ...
  <typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  TTS_EQUAL(kyosu::lipart(type(r,i,j,k,l,li,lj,lk)), li );
};
