...
TTS_CASE_WITH("Check kyosu::is_not_finite over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
...
<typename T>(T r, T i, T j, T k)
{
  ...
  auto z(eve::inf(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_finite(type(r, i, j, k)),
            eve::is_not_finite(r) || eve::is_not_finite(i) || eve::is_not_finite(j) || eve::is_not_finite(k));
  TTS_EQUAL(kyosu::is_not_finite(z), eve::true_(eve::as(r)));
};
...
<typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  auto z(eve::inf(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_finite(type(r, i, j, k, l, li, lj, lk)),
            eve::is_not_finite(r) || eve::is_not_finite(i) || eve::is_not_finite(j) || eve::is_not_finite(k) ||
