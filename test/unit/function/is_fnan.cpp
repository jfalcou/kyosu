...
TTS_CASE_WITH ( "Check kyosu::is_fnan over real"
              , kyosu::real_types
...
TTS_CASE_WITH ( "Check kyosu::is_fnan over complex"
              , kyosu::real_types
  ...
  <typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  auto z(kyosu::fnan(eve::as(r)));
  TTS_EQUAL(kyosu::is_fnan(type(r,i,j,k,l,li,lj,lk)), eve::is_nan(r) && eve::is_nan(i) && eve::is_nan(j) && eve::is_nan(k)
