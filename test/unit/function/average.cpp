...
TTS_CASE_WITH("Check kyosu::average over real", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10)

)
(auto r0, auto r1)
{
  using T = decltype(r0);
  TTS_EQUAL(kyosu::average(r0), r0);
