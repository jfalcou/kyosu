...
TTS_CASE_WITH("Check kyosu::is_not_nan over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
  TTS_EQUAL(kyosu::is_not_nan(data), eve::is_not_nan(data));
};

TTS_CASE_WITH("Check kyosu::is_not_nan over complex", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10))
(auto r, auto i)
{
...
<typename T>(T r, T i, T j, T k)
{
  ...
  auto z(eve::nan(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_nan(type(r, i, j, k)),
...
<typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  auto z(eve::nan(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_nan(type(r, i, j, k, l, li, lj, lk)),
            eve::is_not_nan(r) && eve::is_not_nan(i) && eve::is_not_nan(j) && eve::is_not_nan(k) &&
