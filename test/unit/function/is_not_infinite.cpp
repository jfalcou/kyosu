...
TTS_CASE_WITH("Check kyosu::is_not_infinite over real", kyosu::real_types, tts::randoms(-10, 10))
(auto data)
{
...
<typename T>(T r, T i, T j, T k)
{
  ...
  auto z(eve::inf(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_infinite(type(r, i, j, k)),
            eve::is_not_infinite(r) && eve::is_not_infinite(i) && eve::is_not_infinite(j) && eve::is_not_infinite(k));
  TTS_EQUAL(kyosu::is_not_infinite(z), eve::false_(eve::as(r)));
};
...
<typename T>(T r, T i, T j, T k, T l, T li, T lj, T lk)
{
  ...
  auto z(eve::inf(eve::as(r)));
  TTS_EQUAL(kyosu::is_not_infinite(type(r, i, j, k, l, li, lj, lk)),
            eve::is_not_infinite(r) && eve::is_not_infinite(i) && eve::is_not_infinite(j) && eve::is_not_infinite(k) &&
              eve::is_not_infinite(l) && eve::is_not_infinite(li) && eve::is_not_infinite(lj) &&
              eve::is_not_infinite(lk));
  TTS_EQUAL(kyosu::is_not_infinite(z), eve::false_(eve::as(r)));
};
