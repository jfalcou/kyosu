...
<typename T>(T a0, T a1)
{
  ...
  TTS_EQUAL(i1c, -sph_bessel_i1_1(cm));
  TTS_EQUAL(i2c, sph_bessel_i2_1(cm));
  TTS_EQUAL(i1c, kyosu::conj(sph_bessel_i1_1(cb)));
  TTS_EQUAL(i2c, kyosu::conj(sph_bessel_i2_1(cb)));
