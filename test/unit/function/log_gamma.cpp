...
<typename T>(T a0, T a1, T a2, T a3)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::log_gamma[cond][kyosu::real_only](r), kyosu::if_else(cond,  eve::log_gamma(r), r), tts::prec<T>());
  ...
  TTS_RELATIVE_EQUAL(kyosu::log_gamma[cond](r, 2), kyosu::if_else(cond,  kyosu::log_gamma(r, 2), ce_t(r)), tts::prec<T>());
