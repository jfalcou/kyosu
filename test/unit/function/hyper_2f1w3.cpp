...
<typename T>(tts::type<T>)
{
  ...
  if constexpr (sizeof(T) == 8)
  {
    ...
    }
    {
      ...
      eve::wide res{1.41666666666667 + 0 * I, 1.53571428571429 + 0 * I, 0.666666666666667 + 0 * I,
                    1.43805509807655 + 0 * I};
      auto r = kyosu::hypergeometric(z, kumi::tuple{a, b}, kumi::tuple{c});
      TTS_RELATIVE_EQUAL(r, res, pr);
    }
    {
      ...
      eve::wide res{3.8571428571428571 + 0 * I, -0.094543453005056519816 - 0.0128699542349234016572936919 * I,
                    0.2924304510986073277883 + 0 * I, 4.26012617974385730373092 - 2.136130533701953350 * I};
      auto r = kyosu::hypergeometric(z, kumi::tuple{a, b}, kumi::tuple{c});
      TTS_RELATIVE_EQUAL(r, res, pr);
    }

    {
      ...
      eve::wide res{3.25898889914176 + 0 * I, 0.784430166457414 + 0 * I, -332.644427109329 - 224.988297979129 * I,
...

    {
      ...
      eve::wide res{1.1172786872818116653 - 0.01890970717512781 * I, 0.08945210258112101 - 0.160349515471060001 * I,
  ...
  else
  {
    ...
    }
    {
      ...
      eve::wide res{1.41666666666667f + 0 * I, 1.53571428571429f + 0 * I, 0.666666666666667f + 0 * I,
                    1.43805509807655f + 0 * I};
      auto r = kyosu::hypergeometric(z, kumi::tuple{a, b}, kumi::tuple{c});
      TTS_RELATIVE_EQUAL(r, res, pr);
    }
    {
      ...
      eve::wide res{3.8571428571428571f + 0 * I, -0.094543453005056519816f - 0.0128699542349234016572936919f * I,
                    0.2924304510986073277883f + 0 * I, 4.26012617974385730373092f - 2.136130533701953350f * I};
      auto r = kyosu::hypergeometric(z, kumi::tuple{a, b}, kumi::tuple{c});
      TTS_RELATIVE_EQUAL(r, res, pr);
    }
    {
      ...
      eve::wide res{3.25898889914176f + 0 * I, 0.784430166457414f + 0 * I, -332.644427109329f - 224.988297979129f * I,
...

    {
      ...
      eve::wide res{0.9390912752f - 0.107445335799431f * I, 0.08945210258112101f - 0.160349515471060001f * I,
