...
TTS_CASE_WITH("Check kyosu::ldiv over real", kyosu::real_types, tts::randoms(-10, 10), tts::randoms(-10, 10)
...
<typename T>(T r0, T i0, T j0, T k0, T r1, T i1, T j1, T k1)
{
  ...
  TTS_RELATIVE_EQUAL(kyosu::ldiv(kumi::tuple{q0, q1, r0}), kyosu::ldiv(q0, (q1 * r0)), tts::prec<T>());
};
