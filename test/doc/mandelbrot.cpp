...
//        if (i == 10 && j == 10) std::cout << z0 << std::endl;
        c_t z(0);
        T n2 =  std::norm(z);
    ...
    return iterations[size*size-1];
  }
  //! [mandelbrot-complex-std]

  //! [mandelbrot-complex-scalar]
  auto evaluate_complex_scalar()
  {
...
// This code can be compiled on linux using
