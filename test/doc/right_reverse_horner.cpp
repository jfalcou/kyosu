...
int main() {
  ...
  //   std::cout << "right_reverse_horner(a[0],a[1],a[2],a[3], a[4]) " <<
  //   kyosu::right_reverse_horner(a[0],a[1],a[2],a[3], a[4]) << std::endl;
  ...
  //   std::cout << "right_reverse_horner(x, q1, c2, a[2]) " << kyosu::right_reverse_horner(x, q1, c2, a[12]) <<
  //   std::endl;
  ...
  //   std::cout << "right_reverse_horner(x, o1, c2, a[2]) " << kyosu::right_reverse_horner(x, o1, c2, a[12]) <<
  //   std::endl;
};
