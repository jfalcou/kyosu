...
int main()
{
  ...
  std::cout << "Complex:  \n";
  std::cout << kyosu::complex(3.0)         << " -> " << cyl_bessel_jn(n, kyosu::complex(3.0)) << "\n";
  std::cout << kyosu::complex(63.0)        << " -> " << cyl_bessel_jn(n, kyosu::complex(63.0)) << "\n";
  std::cout << kyosu::complex(0.0, 3.0)    << " -> " << cyl_bessel_jn(n, kyosu::complex(0.0, 3.0)) << "\n";
  std::cout << kyosu::complex(0.0, 23.0)   << " -> " << cyl_bessel_jn(n, kyosu::complex(0.0, 23.0)) << "\n";
