...
int main()
{
  ...
  std::cout << "right_horner(a[0],a[1],a[2],a[3], a[4]) " << kyosu::horner[eve::right](a[0],a[1],a[2],a[3], a[4]) << std::endl;
  ...
  std::cout << "right_horner(x, q1, q2, q3) " << kyosu::horner[eve::right](x, q1, q2, q3) << std::endl;
  auto x1= kyosu::complex(a[1],a[6]);
  auto c1= kyosu::complex(a[4],a[3]);
  auto c2= kyosu::complex(a[8],a[9]);
  auto c3= kyosu::complex(a[1],a[2]);
  std::cout << "right_horner(x1, q1, c2, a[2]) " << kyosu::horner[eve::right](x1, q1, c2, a[12]) << std::endl;
//   auto z = kyosu::right_horner(x1, c1, c2, c3);
//     std::cout << z <<  std::endl;
  std::cout << "right_horner(x, c1, c2, c3) " << kyosu::horner[eve::right](x, c1, c2, c3) << std::endl;
  std::cout << "right_horner(x1, c1, c2, c3) " << kyosu::horner[eve::right](x1, c1, c2, c3) << std::endl;
  ...
  std::cout << "right_horner(x, o1, o2, o3  ) " << kyosu::horner[eve::right](x, o1, o2, o3   ) << std::endl;
  std::cout << "right_horner(x, o1, c2, a[2]) " << kyosu::horner[eve::right](x, o1, c2, a[12]) << std::endl;
};
