...
//   {};
  ...
  struct result<Z0,Z1> : kyosu::as_cayley_dickson_like<kyosu::as_real_type_t<Z0>, Z1>
  {};

  template<kyosu::concepts::cayley_dickson_like Z0, eve::integral_scalar_value Z1>
  struct result<Z0,Z1> : decltype(kyosu::abs(Z0())) //kyosu::as_real_type_t<Z0>
  {};

//   template<eve::floating_scalar_value Z0, kyosu::concepts::real Z1>
//   struct result<Z0,Z1> : kyosu::as_cayley_dickson_like<Z0, Z1>
//   {};
...
//     return that_t(kyosu::abs(z0));
//   }

//   template<kyosu::concepts::cayley_dickson_like Z0, eve::integral_scalar_value Z1>
//   KYOSU_FORCEINLINE constexpr
//   typename result<Z0,Z1>::type operator()(Z0 z0, Z1 ) const noexcept
//   //  Z0 operator()(Z0 z0, Z1 ) const noexcept
//   {
// //     using that_t = decltype(kyosu::abs(z0)); //typename result<Z0,Z1>::type;
//        using that_t =typename result<Z0,Z1>::type;
//      std::cout << that_t(kyosu::abs(z0))<< '\n';
//     return kyosu::abs(z0);
//   }
};
