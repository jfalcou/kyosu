...
int main()
{
  ...
  q_t q0(1, 5, 2, 3);
  q_t q1(5, 9, 6, 7);
  std::cout << q0 << ", " << q1 << " -> "  << rising_factorial(q0, q1) << "\n";
  std::cout << q0 << ", " << q0 << " -> "  << rising_factorial(q0, q0) << "\n";
  wq_t wq0(q0, q1);
  wq_t wq1(q1, q1);
  std::cout << wq0 << ", " << wq1 << " -> " << rising_factorial(wq0, wq1) << "\n";

  std::cout << "Mixed:  "<< "\n";
  std::cout << kyosu::rising_factorial(c0, q1) << std::endl;
  std::cout << kyosu::rising_factorial(e0, q1) << std::endl;
  std::cout << kyosu::rising_factorial(c0, wq1) << std::endl;
  std::cout << kyosu::rising_factorial(we0, q1) << std::endl;
