...
int main()
{
  ...
  std::cout               << is_real(kyosu::to_complex(we))<< "\n";
  std::cout               << is_real(kyosu::to_quaternion(we))<< "\n";
  ...
  std::cout                 << is_real(kyosu::to_complex(wc))<< "\n";;
  std::cout                 << is_real(kyosu::to_quaternion(wc))<< "\n";
