...
int main()
{
  ...
  std::cout << "1+0i            " << " -> " << cyl_bessel_j1(kyosu::complex(1.0, 0.0)) << "\n";
  std::cout << "15.0            " << " -> " << cyl_bessel_j1(15.0) << "\n";
  std::cout << "15+0i           " << " -> " << cyl_bessel_j1(kyosu::complex(15.0, 0.0)) << "\n";
  std::cout << "40.0            " << " -> " << cyl_bessel_j1(40.0) << "\n";
  std::cout << "40+0i           " << " -> " << cyl_bessel_j1(kyosu::complex(40.0, 0.0)) << "\n";
  std::cout << "60.0            " << " -> " << cyl_bessel_j1(60.0) << "\n";
  std::cout << "60+0i           " << " -> " << cyl_bessel_j1(kyosu::complex(60.0, 0.0)) << "\n";

  eve::wide<double, eve::fixed<4>> z(1.0, 15.0, 40.0, 60.0);
  auto zz = kyosu::complex(z);
  std::cout << z  << "\n -> " << cyl_bessel_j1(z) << "\n";
  std::cout << zz << "\n -> " << kyosu::real(cyl_bessel_j1(zz)) << "\n";
