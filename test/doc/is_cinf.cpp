...
int main()
{
  ...
  std::cout << c << " -> " << is_cinf(c) << "\n";
  std::cout << wc << " -> " << is_cinf(wc) << "\n";
  std::cout << is_cinf(kyosu::complex(wc)) << "\n";
  ;
  std::cout << is_cinf(kyosu::quaternion(wc)) << "\n";
  ...
  std::cout << q << " -> " << is_cinf(q) << "\n";
  std::cout << wq << " -> " << is_cinf(wq) << "\n";
