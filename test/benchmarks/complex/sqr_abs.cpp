...
<typename T>(tts::type<T>)
{
...

  {
    ...
    TTS_RUN_BENCHMARK_TPL(_, type, "kyosu::scalar pedantic", kyosu::sqr_abs[kyosu::pedantic], rnd_kyosu);
    TTS_RUN_BENCHMARK_TPL(_, eve::wide<type>, "kyosu::wide", kyosu::sqr_abs, rnd_kyosu);
    TTS_RUN_BENCHMARK_TPL(_, eve::wide<type>, "kyosu::wide pedantic", kyosu::sqr_abs[kyosu::pedantic], rnd_kyosu);
  }
