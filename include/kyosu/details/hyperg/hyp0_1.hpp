...
namespace kyosu::_
{
  ...
  //===-------------------------------------------------------------------------------------------
  //===-------------------------------------------------------------------------------------------
  template<typename Z, eve::sized_product_type<0> T1, eve::sized_product_type<1> T2>
  KYOSU_FORCEINLINE auto hyperg(Z z, T1, T2 aa)
  {
  ...
  template<typename Z, eve::sized_product_type<0> T1, eve::sized_product_type<1> T2>
  KYOSU_FORCEINLINE auto hyperg(Z z, T1, T2 cc, decltype(kyosu::regularized))
  {
