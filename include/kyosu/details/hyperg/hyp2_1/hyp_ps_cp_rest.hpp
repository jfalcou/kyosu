...
namespace kyosu::_
{
  auto hyp_ps_cp_rest(auto a, auto b, auto c, auto z, auto notdone) noexcept
  {
    ...
    r_t hyp_ps_z0 =
      kyosu::if_else(is_abs_z_small, hyp_ps_zero(a, b, c, z0, notdone), hyp_ps_infinity(a, b, c, z0, notdone));
    r_t dhyp_ps_z0 = kyosu::if_else(is_abs_z_small, hyp_ps_zero(inca, incb, incc, z0, notdone),
