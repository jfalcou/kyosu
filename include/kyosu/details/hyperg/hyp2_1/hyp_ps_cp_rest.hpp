...
//       const u_t prec = tol*(kyosu::linfnorm (an) + kyosu::linfnorm (anp1));
...
//     else
    {
      ...
      r_t hyp_ps_z0  = kyosu::if_else(is_abs_z_small, hyp_ps_zero (a,b,c,z0),  hyp_ps_infinity (a,b,c,z0, notdone));
