...
{
  struct callable_cyl_bessel_h1_0: eve::elementwise
  {
    using callable_tag_type = callable_cyl_bessel_h1_0;

    KYOSU_DEFERS_CALLABLE(cyl_bessel_h1_0_);
    ...
    template<typename... T>
    eve::unsupported_call<callable_cyl_bessel_h1_0(T&&...)> operator()(T&&... x) const
...
//! @}
//======================================================================================================================
inline constexpr tags::callable_cyl_bessel_h1_0 cyl_bessel_h1_0 = {};
}
