...
namespace kyosu
{
  template<typename Options> struct maxmag_t : eve::tuple_callable<maxmag_t, Options>
  {
    ...
    KYOSU_FORCEINLINE constexpr typename kyosu::as_cayley_dickson_like_t<Z0, Z1, Zs...> operator()(
      Z0 z0, Z1 z1, Zs... zs) const noexcept
    {
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto maxmag_(KYOSU_DELAY(), O const& o, Z0 z0, Z1 z1, Zs... zs) noexcept
  {
