...
namespace kyosu
{
  ...
  struct asin_t
    : eve::strict_elementwise_callable<asin_t, Options, raw_option, pedantic_option, real_only_option, radpi_option>
  {
...
namespace kyosu
{
  namespace _
  {
    ...
    requires(!O::contains(real_only))
    {
      return eve::_::mask_op(cx, eve::_::return_2nd, complex(z), asin[o](z, k...));
    }
  }
