...
namespace kyosu
{
  ...
  struct dist_t : eve::strict_elementwise_callable<dist_t, Options, raw_option, eve::pedantic_option, eve::numeric_option>
  {
  ...
  //!      2. if the pedantic option is used the distance between an infinite value an anything (even a nan) is
  //!      infinite.
  //!      3. the numeric option implies pedantic and return zero if all corresponding parts satisfy
  //!      `eve::is_equal[numeric]`.
  //!
