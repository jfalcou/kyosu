...
namespace kyosu
{
  ...
  struct is_cinf_t : eve::elementwise_callable<is_cinf_t, Options, raw_option, pedantic_option>
  {
  ...
  //======================================================================================================================
  //! @defgroup is_cinf kyosu::is_cinf
  //! @ingroup agnostic
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr eve::as_logical_t<Z> is_cinf_(KYOSU_DELAY(), O const&, Z const& z) noexcept
  {
    if constexpr (concepts::real<Z>) return eve::false_(eve::as(z));
    else return kyosu::is_nan(z) && kyosu::is_infinite(z);
  }
}
