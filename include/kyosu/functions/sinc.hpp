...
namespace kyosu
{
  template<typename Options> struct sinc_t : eve::elementwise_callable<sinc_t, Options, raw_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (kyosu::concepts::real<Z>) return eve::sinc(z);
