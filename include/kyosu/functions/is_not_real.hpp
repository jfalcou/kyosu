...
namespace kyosu
{
  ...
  struct is_not_real_t : eve::elementwise_callable<is_not_real_t, Options, raw_option, pedantic_option>
  {
  ...
  //======================================================================================================================
  //! @defgroup is_not_real kyosu::is_not_real
  //! @ingroup agnostic
...
namespace kyosu::_
{
  ...
  {
    if constexpr (kyosu::concepts::real<Z>) return eve::false_(eve::as(c));
    else if constexpr (kyosu::concepts::complex<Z>) return eve::is_nez(ipart(c));
    else
    {
