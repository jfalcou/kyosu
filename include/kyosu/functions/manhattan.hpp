...
namespace kyosu
{
  ...
  struct manhattan_t : eve::strict_tuple_callable<manhattan_t, Options, eve::saturated_option, eve::pedantic_option, eve::kahan_option>
  {

    template<concepts::cayley_dickson_like ...Zs>
    KYOSU_FORCEINLINE constexpr
    auto operator()(Zs... zs) const noexcept -> decltype(eve::manhattan(real(zs)...))
    {
