...
namespace kyosu
{
  template<typename Options> struct dot_t : kyosu::strict_tuple_callable<dot_t, Options, eve::kahan_option>
  {
    ...
    template<eve::concepts::non_empty_product_type Tup1, eve::concepts::non_empty_product_type Tup2>
...
namespace kyosu::_
{
  ...
  template<eve::concepts::non_empty_product_type Tup1,
           eve::concepts::non_empty_product_type Tup2,
