...
namespace kyosu
{
  ...
  struct sqrt_t : eve::strict_elementwise_callable<sqrt_t, Options, raw_option, pedantic_option, real_only_option>
  {
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto sqrt_(KYOSU_DELAY(), C const& cx, O const&, Z z, K... k) noexcept
  requires(!O::contains(real_only))
  {
    return eve::_::mask_op(cx, eve::_::return_2nd, complex(z), sqrt(z, k...));
  }
}
