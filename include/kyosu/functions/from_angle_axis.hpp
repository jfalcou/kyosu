...
namespace kyosu
{
  ...
  struct from_angle_axis_t
    : eve::strict_elementwise_callable<from_angle_axis_t, Options, assume_unitary_option, rad_option, radpi_option>
  {
  ...
  //!     auto from_angle_axis[radpi](auto angle, auto axis) const          noexcept;
  //!   }
  //!   @endcode
  //!
  //! **Parameters**
  //!
  //!  * `angle`: rotation angle in radian or (in \f$\pi\f$ multiples if radpi otion is present)
