...
namespace kyosu
{
  ...
  struct log_t : eve::strict_elementwise_callable<log_t, Options, raw_option, radpi_option, real_only_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  requires(!O::contains(real_only))
  {
    ...
    else { return _::cayley_extend(kyosu::log, z, k); }
  }
