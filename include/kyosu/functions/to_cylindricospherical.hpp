...
namespace kyosu
{
  ...
  struct to_cylindricospherical_t : eve::elementwise_callable<to_cylindricospherical_t, Options>
  {
    ...
    KYOSU_CALLABLE_OBJECT(to_cylindricospherical_t, to_cylindricospherical_);
  };
  ...
  //================================================================================================
  inline constexpr auto to_cylindricospherical = eve::functor<to_cylindricospherical_t>;
  //================================================================================================
  //!  @}
  //================================================================================================
}
