...
//!
//!   2. Returns kyosu::radinpi([kyosu::asin](@ref kyosu::asin)(z))
//!
//!  @groupheader{Example}
//!
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto asinpi_(KYOSU_DELAY(), O const&, Z z) noexcept
  {
   return kyosu::radinpi(kyosu::asin(z));
  }
}
