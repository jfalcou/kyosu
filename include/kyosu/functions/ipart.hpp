...
//!   namespace kyosu
//!   {
//!      template<kyosu::concepts::cayley_dickinson T> constexpr auto& ipart(T& z)        noexcept;
//!      template<kyosu::concepts::cayley_dickinson T> constexpr auto  ipart(T const& z)  noexcept;
