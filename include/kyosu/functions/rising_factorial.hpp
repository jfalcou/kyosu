...
namespace kyosu
{
  ...
  struct rising_factorial_t
    : eve::strict_elementwise_callable<rising_factorial_t, Options, raw_option, pedantic_option, real_only_option>
  {
...
namespace kyosu::_
{
  ...
  {
    return eve::_::mask_op(cx, eve::_::return_2nd, complex(z0), rising_factorial(z0, z1));
  }
