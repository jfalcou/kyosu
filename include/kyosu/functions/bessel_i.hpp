...
namespace kyosu
{
  ...
  //!   namespace kyosu
  //!   {
  //!      template<eve;scalar_value N, kyosu::concepts::cayley_dickson_like T>    constexpr auto bessel_i(N n, T z)
  //!      noexcept; //1 template<eve;scalar_value N, kyosu::concepts::complex_like T, size_t S> constexpr auto
  //!      bessel_i(N n, T z, std::span<Z, S> cis)            noexcept; //2 template<eve;scalar_value N,
  //!      kyosu::concepts::cayley_dickson_like T>    constexpr auto bessel_i[spherical](N n, T z) noexcept; //3
  //!      template<eve;scalar_value N, kyosu::concepts::complex_like T, size_t S> constexpr auto bessel_i[spherical](N
