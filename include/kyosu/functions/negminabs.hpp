...
namespace kyosu
{
  ...
  struct negminabs_t
    : eve::strict_elementwise_callable<negminabs_t, Options, raw_option, eve::numeric_option, eve::pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto negminabs_(KYOSU_DELAY(), O const& o, Z0 z0, Zs... zs) noexcept
  {
    if constexpr (concepts::real<Z0> && (... && concepts::real<Zs>)) return eve::negminabs[o](z0, zs...);
    else return eve::minus(kyosu::minabs[o](z0, zs...));
  }
}
