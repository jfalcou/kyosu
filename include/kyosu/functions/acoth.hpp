...
namespace kyosu
{
  template<typename Options> struct acoth_t : eve::strict_elementwise_callable<acoth_t, Options, raw_option, pedantic_option, real_only_option>
  {
  ...
  //!   Cotangent](https://mathworld.wolfram.com/InverseHyperbolicCotangent.html)
