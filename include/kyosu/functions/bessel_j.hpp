...
namespace kyosu
{
  ...
  struct bessel_j_t
    : eve::strict_elementwise_callable<bessel_j_t, Options, eve::spherical_option, eve::cylindrical_option>
  {
    ...
    KYOSU_FORCEINLINE constexpr as_cayley_dickson_like_t<N, Z> operator()(N const& n,
                                                                          Z const& z,
                                                                          std::span<Z, S> js) const noexcept
    {
  ...
  //!   namespace kyosu
  //!   {
  //!      template<eve;scalar_value N, kyosu::concepts::cayley_dickson_like T>    constexpr auto bessel_j(N n, T z)
  //!      noexcept; //1 template<eve;scalar_value N, kyosu::concepts::complex_like T, size_t S> constexpr auto
  //!      bessel_j(N n, T z, std::span<Z, S> cjs)            noexcept; //2 template<eve;scalar_value N,
  //!      kyosu::concepts::cayley_dickson_like T>    constexpr auto bessel_j[spherical](N n, T z) noexcept; //3
  //!      template<eve;scalar_value N, kyosu::concepts::complex_like T, size_t S> constexpr auto bessel_j[spherical](N
  //!      n, T z, std::span<Z, S> sjs) noexcept; //4
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
