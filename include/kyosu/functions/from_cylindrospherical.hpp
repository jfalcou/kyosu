...
namespace kyosu
{
  ...
  struct from_cylindrospherical_t
    : eve::elementwise_callable<from_cylindrospherical_t, Options, raw_option, pedantic_option, radpi_option>
  {
    ...
    KYOSU_CALLABLE_OBJECT(from_cylindrospherical_t, from_cylindrospherical_);
  };
  ...
  //================================================================================================
  inline constexpr auto from_cylindrospherical = eve::functor<from_cylindrospherical_t>;
  //======================================================================================================================
  //! @}
  //======================================================================================================================
}
