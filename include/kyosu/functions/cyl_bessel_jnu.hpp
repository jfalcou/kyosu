...
{
  struct callable_cyl_bessel_jnu: eve::elementwise
  {
    using callable_tag_type = callable_cyl_bessel_jnu;
    ...
    template<typename... T>
    eve::unsupported_call<callable_cyl_bessel_jnu(T&&...)> operator()(T&&... x) const
...
//!      constexpr auto cyl_bessel_jnu(N nu, T z) noexcept;
//!
//!      template<eve::floating_ordered_value, eve::floating_ordered_value T>
//!      constexpr T    cyl_bessel_jnu(N n, T z) noexcept;
//!   }
//!   @endcode
//!
//!   **Parameters**
...
//!  @groupheader{Example}
//!
//!  @godbolt{doc/cyl_bessel_jnu.cpp}
//! @}
//======================================================================================================================
inline constexpr tags::callable_cyl_bessel_jnu cyl_bessel_jnu = {};
}
