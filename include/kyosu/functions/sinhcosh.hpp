...
namespace kyosu
{
  template<typename Options> struct sinhcosh_t : eve::callable<sinhcosh_t, Options, raw_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (kyosu::concepts::real<Z>) return eve::sinhcosh(z);
