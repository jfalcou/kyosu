...
namespace kyosu
{
  template<typename Options> struct sub_t : kyosu::strict_tuple_callable<sub_t, Options, eve::kahan_option>
  {
  ...
  //!      constexpr auto sub(eve::concepts::non_empty_product_type auto const& tup)             noexcept; // 2
