...
namespace kyosu
{
  template<typename Options> struct acscpi_t : eve::strict_elementwise_callable<acscpi_t, Options, real_only_option>
  {
  ...
  //!
  //!     // semantic modifyers
  //!     constexpr Z acscpi[real_only](Real z)                      noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!     eve::acscpi implying a Nan result if the theoretical result is not real.
