...
namespace kyosu
{
  ...
  struct powm1_t : eve::strict_elementwise_callable<powm1_t, Options, raw_option, pedantic_option, real_only_option>
  {
    ...
    KYOSU_FORCEINLINE constexpr auto operator()(Z0 z0, Z1 z1) const noexcept -> eve::as_wide_as_t<Z0, Z1>
...
namespace kyosu::_
{
  ...
  {
    if constexpr (O::contains(real_only)) return kyosu::inject(eve::powm1(z0, z1));
    ...
    else return kyosu::dec(kyosu::pow(z0, z1));
  }
}
