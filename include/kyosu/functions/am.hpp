...
namespace kyosu
{
  ...
  struct am_t : eve::strict_elementwise_callable<am_t,
                                                 Options,
                                                 raw_option,
                                                 pedantic_option,
                                                 eve::modular_option,
  ...
  //!      Each of the above three quantities is completely determined by any of the others (given that they are
  //!      non-negative). Thus, they can be used interchangeably up to roundings errors by giving the right option.
  //!   * curently the function is only defined for complex like values of the first parameter.
  //!
