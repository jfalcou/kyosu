...
namespace kyosu
{
  template<typename Options> struct fnms_t : eve::strict_elementwise_callable<fnms_t, Options, raw_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (concepts::real<Z0> && concepts::real<Z1> && concepts::real<Z2>) return eve::fnms(z0, z1, z2);
