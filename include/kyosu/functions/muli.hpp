...
namespace kyosu
{
  ...
  struct muli_t : eve::elementwise_callable<muli_t, Options, raw_option, pedantic_option, eve::left_option, eve::right_option>
  {
...
namespace kyosu::_
{
  template<typename Z, eve::callable_options O> constexpr auto muli_(KYOSU_DELAY(), O const& o, Z z) noexcept
  {
