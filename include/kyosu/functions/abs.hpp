...
namespace kyosu
{
  template<typename Options> struct abs_t : eve::elementwise_callable<abs_t, Options, pedantic_option, eve::raw_option, flat_option>
  {
  ...
  //!       oly items c, f; g, h, i, k are satisfied
