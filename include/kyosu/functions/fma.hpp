...
namespace kyosu
{
  ...
  struct fma_t : eve::strict_elementwise_callable<fma_t, Options, raw_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (concepts::real<Z0> && concepts::real<Z1> && concepts::real<Z2>) return eve::fma(z0, z1, z2);
