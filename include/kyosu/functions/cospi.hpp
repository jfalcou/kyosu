...
namespace kyosu
{
  template<typename Options> struct cospi_t : eve::elementwise_callable<cospi_t, Options>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (eve::floating_value<Z>) return eve::cospi(z);
    ...
    else { return _::cayley_extend(kyosu::cospi, z); }
  }
}
