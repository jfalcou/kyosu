...
namespace kyosu
{
  ...
  struct lerp_t : eve::strict_elementwise_callable<lerp_t, Options, raw_option, pedantic_option>
  {
...
namespace kyosu::_
{
  ...
  {
    if constexpr (concepts::real<Z0> && concepts::real<Z1>) return eve::lerp(c0, c1, t);
    else
    {
