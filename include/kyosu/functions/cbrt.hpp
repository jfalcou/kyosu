...
namespace kyosu
{
  ...
  struct cbrt_t : eve::strict_elementwise_callable<cbrt_t, Options, raw_option, real_only_option, pedantic_option>
  {
  ...
  //!   *  [Wikipedia: Cube root](https://en.wikipedia.org/wiki/Cube_root)
  //!
  //!
  //!  @groupheader{Example}
