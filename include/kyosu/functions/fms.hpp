...
{
  struct callable_fms: eve::elementwise
  {
    using callable_tag_type = callable_fms;

    KYOSU_DEFERS_CALLABLE(fms_);
    ...
    template<typename... T>
    eve::unsupported_call<callable_fms(T&&...)> operator()(T&&... x) const
...
//! @}
//======================================================================================================================
inline constexpr tags::callable_fms fms = {};
}
