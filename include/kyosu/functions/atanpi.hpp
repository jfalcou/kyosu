...
namespace kyosu
{
  template<typename Options> struct atanpi_t : eve::strict_elementwise_callable<atanpi_t, Options, real_only_option>
  {
  ...
  //!     in which case the parameter must be a floating_value and the result will the same as a call to `eve::atanpi`,
