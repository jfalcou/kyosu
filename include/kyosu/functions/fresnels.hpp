...
namespace kyosu
{
  ...
  struct fresnels_t : eve::elementwise_callable<fresnels_t, Options>
  {
    ...
    KYOSU_FORCEINLINE constexpr Z operator()(Z const& z) const noexcept
    {
      ...
      auto z2 = kyosu::sqr(z);
      auto zz = -eve::pi2o_16(eve::as<u_t>())*kyosu::sqr(z2)
      return pi_o6*z*z2*kyosu::hypergeometric(zz, kumi::tuple{u_t(0.75)}, kumi::tuple{u_t(1.75), u_t(1.5)});
    }
...
//! @{
//!   @var fresnels
//!   @brief Computes the Fresnel \f$C\f$ integral \f$\int_0^{\infty} \sin(\frac12 \pi t^2 \;\mathrm{d}t\\f$.
//!
