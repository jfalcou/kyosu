...
//!      template<kyosu::concepts::complex T>        constexpr auto sph_bessel_i1n(int n, T z, std::span<T> js)  noexcept;
//!      template<kyosu::concepts::real T>           constexpr T    sph_bessel_i1n(int n, T z) noexcept;
//!      template<kyosu::concepts::real T>           constexpr T    sph_bessel_i1n(int n, T z, std::span<T> js)) noexcept;
//!   }
//!   @endcode
//!
//!   **Parameters**
