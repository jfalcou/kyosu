...
namespace kyosu
{
  ...
  struct sph_bessel_jyn_t : eve::strict_elementwise_callable<sph_bessel_jyn_t, Options>
  {
    ...
    KYOSU_CALLABLE_OBJECT(sph_bessel_jyn_t, sph_bessel_jyn_);
};
...
//! @{
//!   @var sph_bessel_jyn
//!   @brief Computes  simultaneously the Bessel functions of the first and second kind,
//!
//!   @code
...
//!   namespace kyosu
//!   {
//!      template<kyosu::concepts::cayley_dickson T constexpr auto sph_bessel_jyn(int n, T z) noexcept;
//!      template<kyosu::concepts::complex T constexpr auto sph_bessel_jyn(int n, T z
//!                                                       , std::span<T> js, std::span<T> ys) noexcept;
//!      template<kyosu::concepts::real T>          constexpr auto sph_bessel_jyn(int n, T z) noexcept;
//!      template<kyosu::concepts::real T>          constexpr auto sph_bessel_jyn(int n, T z
//!                                                       , std::span<T> js, std::span<T> ys) noexcept;
//!   }
//!   @endcode
//!
...
//======================================================================================================================
  inline constexpr auto sph_bessel_jyn = eve::functor<sph_bessel_jyn_t>;
//======================================================================================================================
//! @}
//======================================================================================================================
}
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto sph_bessel_jyn_(KYOSU_DELAY(), O const&, N n, Z z
  ...
  KYOSU_FORCEINLINE constexpr auto sph_bessel_jyn_(KYOSU_DELAY(), O const&, N n, Z z) noexcept
  {
    ...
    {
      return cayley_extend_rev2(sph_bessel_jyn, n, z);
    }
  }
}
