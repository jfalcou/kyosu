...
namespace kyosu
{
  ...
  struct is_not_fnan_t : eve::elementwise_callable<is_not_fnan_t, Options, raw_option, pedantic_option>
  {
  ...
  //======================================================================================================================
  //! @defgroup is_not_fnan kyosu::is_not_fnan
  //! @ingroup agnostic
...
namespace kyosu::_
{
  ...
  KYOSU_FORCEINLINE constexpr auto is_not_fnan_(KYOSU_DELAY(), O const&, Z z) noexcept
  {
    ...
    else return kumi::any_of(z, eve::is_not_nan);
  }
}
