...
{
  struct callable_sph_bessel_i1_0: eve::elementwise
  {
    using callable_tag_type = callable_sph_bessel_i1_0;

    KYOSU_DEFERS_CALLABLE(sph_bessel_i1_0_);

    template<eve::floating_ordered_value T>
    static KYOSU_FORCEINLINE auto deferred_call(auto, T const& z) noexcept
    {
      return eve::sinhc(z)/z;
    }
    ...
    template<typename... T>
    eve::unsupported_call<callable_sph_bessel_i1_0(T&&...)> operator()(T&&... x) const
...
//! @}
//======================================================================================================================
inline constexpr tags::callable_sph_bessel_i1_0 sph_bessel_i1_0 = {};
}
