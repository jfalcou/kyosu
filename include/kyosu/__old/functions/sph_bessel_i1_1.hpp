...
{
  struct callable_sph_bessel_i1_1: eve::elementwise
  {
    using callable_tag_type = callable_sph_bessel_i1_1;

    KYOSU_DEFERS_CALLABLE(sph_bessel_i1_1_);
    ...
    template<typename... T>
    eve::unsupported_call<callable_sph_bessel_i1_1(T&&...)> operator()(T&&... x) const
...
//! @}
//======================================================================================================================
inline constexpr tags::callable_sph_bessel_i1_1 sph_bessel_i1_1 = {};
}
